...
public class ClienteSteps extends BaseTest {
    ...
    public void o_sistema_deve_exibir_a_mensagem_de_campo_obrigatorio_cpf(String texto) {
        validarTexto(clientePage.messageMandatoryFieldCpf, texto);
    }

    @Então("o sistema deve exibir a mensagem para informar o campo obrigatorio nome {string}")
    public void o_sistema_deve_exibir_a_mensagem_de_campo_obrigatorio_nome(String texto) {
        validarTexto(clientePage.messageMandatoryFieldName, texto);
    }
